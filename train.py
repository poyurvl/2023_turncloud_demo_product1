...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='yolov4.weights', help='initial weights path')#yolov4.weights
    parser.add_argument('--cfg', type=str, default='cfg/yolov4_mod_1013.cfg', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/coco_mod_1013.yaml', help='data.yaml path')#default='data/coco.yaml'
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=300)
    parser.add_argument('--batch-size', type=int, default=8, help='total batch size for all GPUs')#default=8
    parser.add_argument('--img-size', nargs='+', type=int, default=[640, 640], help='[train, test] image sizes')#default=[640, 640]
    parser.add_argument('--rect', action='store_true', help='rectangular training')
    parser.add_argument('--resume', nargs='?', const=True, default=False, help='resume most recent training')#default=False
    ...
    parser.add_argument('--name', default='yolov4-pacsp', help='save to project/name')#default=exp
    parser.add_argument('--exist-ok', action='store_true', help='existing project/name ok, do not increment')
    opt = parser.parse_args()

    # Set DDP variables
    opt.total_batch_size = opt.batch_size
    opt.world_size = int(osplot_study_txt.environ['WORLD_SIZE']) if 'WORLD_SIZE' in os.environ else 1
